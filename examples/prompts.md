...
capture → process → output. Tomochi is somewhere in the middle, deadpan, body straining to handle it.
...
Mini Comic Panels or Concept Metaphor structures. Tomochi's deadpan face against the absurd situation fits well here.
